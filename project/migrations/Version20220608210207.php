 ...
 */
final class Version20220608210207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_BFD3CE8F4D16C4DD ON localisation (shop_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_BFD3CE8F4D16C4DD ON localisation');
